...
final class Http20Draft06 implements Variant {
    ...
    static final class Writer implements FrameWriter {
        ...
        @Override
        public synchronized void headers(int streamId, List<String> nameValueBlock)
                throws IOException {
        ...
        @Override
        public synchronized void data(boolean outFinished, int streamId, byte[] data,
        ...
        @Override
        public synchronized void windowUpdate(int streamId, int deltaWindowSize)
                throws IOException {
            // TODO
        }
