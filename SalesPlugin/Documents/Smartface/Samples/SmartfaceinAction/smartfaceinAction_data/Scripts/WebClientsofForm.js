...
newUserWebClient = new SMF.Net.WebClient(); // webClient object for fetching server response
newUserWebClient.url = "http://services.smartface.io/SmartfaceInAction/NewUser"; // assign url to webclient object
newUserWebClient.httpMethod = "POST"; // assign method type
newUserWebClient.requestHeaders = ["Content-Type: application/json"]; // adding requestHeader
newUserWebClient.ignoreSSLErros = true; //for not breaking the connection on SSL erros
...
// this webclient is using at update profile
updateUserWebClient = new SMF.Net.WebClient(); // webClient object for fetching server response
updateUserWebClient.url = "http://services.smartface.io/SmartfaceInAction/UpdateProfile"; // assign url to webclient object
updateUserWebClient.httpMethod = "PUT"; // assign method type
updateUserWebClient.requestHeaders = ["Content-Type: application/json"]; // adding requestHeader
updateUserWebClient.ignoreSSLErros = true; //for not breaking the connection on SSL erros
