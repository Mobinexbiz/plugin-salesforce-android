                ...
                loginWebClient.onSyndicationSuccess = function (e) {
                    ...
                    if (responseObjectProfile.isSuccess == "false") {
                        ...
                        if (responseObjectProfile.ImageUrl == "") {
                            ...
                            count++;
                            Pages.pgProfile.scrollMainProfile.contUserInfo1.cntProfile.imgProfile.image = responseObjectProfile.ImageUrl + "?" + count;
                        }
                        fromLogin = 1;
...
/**
* Creates action(s) that are run when the user changes the data inside edit box
* @param {EventArguments} e Returns some attributes about the specified functions
* @this SMF.UI.EditBox
*/
...
function pgLogin_btnRegister_OnPressed(e) {
    ...
    pathScroll.contUserInfo2.edtEmail.text = "";
