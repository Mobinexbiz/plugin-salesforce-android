...
/**
 * Creates action(s) that are run when the user pull down the selected item on the repeat box.
 * @param {EventArguments} e Returns some attributes about the specified functions
 * @this SMF.UI.RepeatBox
 */
...
/**
 * Creates action(s) that are run when the user pull up the selected item on the repeat box.
 * @param {EventArguments} e Returns some attributes about the specified functions
 * @this SMF.UI.RepeatBox
 */
 ...
 */
function pgDashboard_txtAddDevelopmentNotes_OnPressed(e) {
    if (appFirstStart) {
        var notesFirstStart = 'Sample Note';
        exportToDocuments(notesFirstStart);
    } else {
        Pages.pgDevelopmentNotesAll.show(SMF.UI.MotionEase.decelerating, SMF.UI.TransitionEffect.rightToLeft, SMF.UI.TransitionEffectType.push, false, false);
    }
}
/**
 * Creates action(s) that are run when the object is pressed from device's screen.
 ...
 * @this SMF.UI.ImageButton
 */
function pgDashboard_btnDevNotes_OnPressed(e) {
    if (appFirstStart) {
        var notesFirstStart = 'Note';
        exportToDocuments(notesFirstStart);
    } else {
        Pages.pgDevelopmentNotesAll.show(SMF.UI.MotionEase.decelerating, SMF.UI.TransitionEffect.rightToLeft, SMF.UI.TransitionEffectType.push, false, false);
    }
...
* @this SMF.UI.ImageButton
*/
function pgDashboard_btnCodeReader_OnPressed(e){
    Pages.pgCodeReader.show(SMF.UI.MotionEase.decelerating, SMF.UI.TransitionEffect.rightToLeft, SMF.UI.TransitionEffectType.push, false, false);
}