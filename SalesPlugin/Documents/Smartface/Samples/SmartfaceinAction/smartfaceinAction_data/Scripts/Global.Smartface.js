...
var codeReaderHeader = "Code Reader";
...
function Global_Events_OnStart(e) {
    ...
    if (Device.deviceOS == 'Android')
        Pages.pgDashboard.cntBottom.Container1.visible = false;
...
var notesObject = {};
var notesDataSource = [];
function exportToDocuments(_noteText) {
    var date = new Date();
    var _year = date.getFullYear();
    var _month = date.getMonth() + 1;
    var _day = date.getDate();
    var dateStr = "" + _year + "-" + _month + "-" + _day;
    var noteText = '';
    noteText = _noteText + 'myNoteSeperator||';
    ...
    if (appFirstStart) {
        var i;
        for (i = 1; i < 6; i++) {
            noteText = _noteText + " " + i + 'myNoteSeperator||';
